...
class Answer(models.Model):
    ...
    answer_text = models.TextField(
        max_length=2000, help_text="Write your answer here..."
    )
    date_created = models.DateField(null=True, default=timezone.now)
    ...
    def __str__(self):
        """String for representing the Model object."""
        return (
            f"Que: {self.question.question_text[:50]}.. Ans: {self.answer_text[:50]}.."
        )


class VoteOption(models.TextChoices):
    up = "up", "UP"
    down = "down", "DOWN"
...
class VoteUser(models.Model):
    ...
    option = models.CharField(max_length=4, choices=VoteOption.choices)
...
class AnswerAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("author", "question", "answer_text")}),
        ("Dates", {"fields": ("date_created", "date_updated")}),
        ("Actions", {"fields": ("upvote", "downvote", "views")}),
    )
